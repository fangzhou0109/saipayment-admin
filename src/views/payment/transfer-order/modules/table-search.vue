<template>
  ...
  >
    <el-col v-bind="setSpan(6)">
      <el-form-item label="平台代付单号" prop="keyword">
        <el-input v-model="formData.keyword" placeholder="请输入平台代付单号" clearable />
      </el-form-item>
    </el-col>
    <el-col v-bind="setSpan(6)">
      <el-form-item label="商户代付单号" prop="out_biz_no">
        <el-input v-model="formData.out_biz_no" placeholder="请输入商户代付单号" clearable />
      </el-form-item>
    </el-col>
    <el-col v-bind="setSpan(6)">
